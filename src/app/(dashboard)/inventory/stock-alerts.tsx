...
import { TriangleAlert as AlertTriangle, Clock, Package, ShoppingCart, Bell, X, Truck } from "lucide-react"
...
export function StockAlerts() {
  ...
  const getAlertColor = (urgency: StockAlert["urgency"]) => {
    switch (urgency) {
      case "critical":
            ...
            {sortedAlerts.map((alert) => (
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className={`p-2 rounded-lg ${getAlertColor(alert.urgency)}`}>{getAlertIcon(alert.type)}</div>
                  ...
                  <div className="flex-1">
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {["expired", "expiring_soon"].includes(alert.type) && (
                    ...
                    <div className="flex items-center justify-between mt-3 pt-3 border-t border-gray-200">
                      <span className="text-xs text-gray-500">Last updated: {alert.lastUpdated}</span>

                      {alert.supplier && <span className="text-xs text-gray-500">Supplier: {alert.supplier}</span>}
                    </div>
                  </div>
                </div>
              </motion.div>
