  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_cell: "text-muted-foreground rounded-md w-11 font-medium text-sm h-11 flex items-center justify-center",
        ...
        day: cn(
          ...
          "h-11 w-11 p-0 font-normal aria-selected:opacity-100 hover:bg-accent hover:text-accent-foreground transition-colors rounded-md",
        ),
